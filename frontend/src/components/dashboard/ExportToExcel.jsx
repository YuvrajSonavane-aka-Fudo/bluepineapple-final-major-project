...
// projData project cells now have per-date counts but NOT which
...
// This still over-assigns. The fix is to track it properly:
...
//
// since we have no direct employee-project mapping in frontend data,
...
function buildEmpProjectMap(empData, projData) {
  ...
  // Return empty map , handle in buildEmpRows by checking cell.project_name
  return {};
}
